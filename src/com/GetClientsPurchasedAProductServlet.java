 ...
 */
@WebServlet("/GetClientsPurchasedAProductServlet")
public class GetClientsPurchasedAProductServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetClientsPurchasedAProductServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			Object orders = null;
			try{
				orders = manager.getClientsOrderedProduct(request.getParameter("productNameToSearch"));
			}
