...
$your_email = "eliagrady19@gmail.com"; // email address to which the form data will be sent
$subject = "Message from site: gradyel.site44.com"; // subject of the email that is sent
		...
		<fieldset> 
			<legend>Contact Us</legend>
				...
				<div>
					...
					<input name="email" type="text" size="40" maxlength="60" id="email" value="'; if (isset($_POST["email"])) {echo $ema;}; echo '">
				</div>
				<div>
	...
	<form method="post" action="<?php $_SERVER['PHP_SELF'] ?>">
		<fieldset> 
			<legend>Contact Us</legend>
				<div>
					<label for="name">Name</label>
					<input name="name" type="text" size="40" maxlength="60" id="name" value="<?php if (isset($_POST["name"])) {echo $nam;} ?>">
				</div>
				<div>
					<label for="email">Email Address</label>
					<input name="email" type="email" size="40" maxlength="60" id="email" value="<?php if (isset($_POST["email"])) {echo $ema;} ?>">
				</div>
				
				<div>
					<label for="comm">Comments</label>
					<textarea name="comments" rows="10" cols="50" id="comm"><?php if (isset($_POST["comments"])) {echo $com;} ?></textarea>
				</div>
